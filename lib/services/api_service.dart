...
class ApiService {
  ...
  static Future<List<Map<String, dynamic>>> getAllDirectors() async {
    try {
      ...
      if (response.statusCode == 200 || response.statusCode == 302) {
        try {
          ...
          if (result['status'] == 'success') {
            ...
            return [
              {
                "first_name": "❌ GAS Error:",
                "last_name": result['message'],
                "active_status": "พ้นสภาพ",
              },
            ];
          }
        } catch (e) {
          ...
          return [
            {
              "first_name": "❌ ไม่ใช่ JSON",
              "last_name": "กรุณาเช็คการ Deploy",
              "active_status": "พ้นสภาพ",
            },
          ];
        }
      ...
      return [
        {
          "first_name": "❌ HTTP Error:",
          "last_name": response.statusCode.toString(),
          "active_status": "พ้นสภาพ",
        },
      ];
    } catch (e) {
      return [
        {
          "first_name": "❌ Network Error:",
          "last_name": e.toString(),
          "active_status": "พ้นสภาพ",
        },
      ];
    }
